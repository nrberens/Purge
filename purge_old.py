...
#implement magic system
	#how to learn spells?
	#spell card allows player to choose spells
	#press button to cast equipped spell
	#uses up mana reserves
	#mana potions restore mana?
#mini player card expands into full player card
#mini target card under the player card
#mouse interaction:
	#right-click brings up context menu, all available actions on that tile
...
class Fighter:
	...
	def __init__(self, plclass, ac, str, dex, con, int, fth, per, equipweapon, equiparmor, hitdie, mindmg, maxdmg, hp, power, defense, death_function=None):
		self.plclass = plclass
		self.ac = ac
		self.str = str
		self.dex = dex
	...
	#choose random spot for this monster
		...
		if not is_blocked(x, y):
			if libtcod.random_get_int(0, 0, 100) < 80: #80% chance of getting an orc
				#create an orc
				fighter_component = Fighter(plclass='None', ac=0, str=10, dex=10, con=10, int=10, fth=10, per=10, equipweapon=None, equiparmor=None, hitdie = 0, mindmg = 0, maxdmg = 0, hp=10, defense=0, power=3, death_function=monster_death)
				ai_component = BasicMonster()

				monster = Object(x, y, 'o', 'orc', libtcod.desaturated_green, blocks=True, fighter=fighter_component, ai=ai_component)
			else:
				#create a troll
				fighter_component = Fighter(plclass='None', ac=0, str=10, dex=10, con=10, int=10, fth=10, per=10, equipweapon=None, equiparmor=None, hitdie = 0, mindmg = 0, maxdmg = 0, hp=16, defense=1, power=4, death_function=monster_death)
				ai_component = BasicMonster()
...
def render_all():
	...
	render_bar(1, 2, BAR_WIDTH, 'Mana', 50, 50, libtcod.light_blue, libtcod.darker_blue)
...
def new_game():
	...
	fighter_component = Fighter(plclass='Warrior', ac=0, str=10, dex=10, con=10, int=10, fth=10, per=10, equipweapon=barehands, equiparmor=birthdaysuit, hitdie = 0, mindmg = 0, maxdmg = 0, hp=500, defense=2, power=5, death_function=player_death)
