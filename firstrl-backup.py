...
#move between dungeon floors
	#do i need to change references to 'map' 'fov_map' etc?
	#code in moving back up a floor
...
class Object:
	...
	def __init__(self, x, y, char, name, color, floor=0, blocks=False, fighter=None, ai=None, item=None, stairs=None):
		self.name = name
		self.blocks = blocks
		self.x = x
		self.y = y
...
class Fighter:
	...
	def attack(self, target):
		#a simple forumla for attack damage
...
def new_game():
	...
	message('As you enter, you hear a disembodied voice whisper: "You will die here, wanderer."', libtcod.red)
