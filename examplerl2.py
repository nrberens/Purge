...
def make_map():
    ...
    #this will place stairs in the last room made
    objects.append(Object(new_x,new_y, '>', 'stairs', libtcod.grey, blocks=False))
...
def clear_map():
    ...
    rooms = []
    num_rooms = 0
    #this will clear the objects from the old level
    objects = []
...
def place_objects(room):
    ...
    for i in range(num_monsters):
        ...
        if not is_blocked(x, y):
            ...
            #on the rare occasion you get 100 this won't work
